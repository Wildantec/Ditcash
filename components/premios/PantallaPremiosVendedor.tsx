    ...
    <div className="min-h-screen bg-[#F8FAFC] p-4 md:p-12 text-[#001F3F]">
      <header className="bg-white rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-10 shadow-xl border border-slate-100 mb-8 md:mb-12 flex flex-col md:flex-row justify-between items-center gap-6 relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 md:gap-6 w-full md:w-auto">
          {/* CORRECCIÓN: Apunta al dashboard unificado principal de DITCASH */}
          <Link href="/dashboard" className="w-10 h-10 md:w-12 md:h-12 bg-slate-50 rounded-xl md:rounded-2xl flex items-center justify-center text-xl hover:bg-[#001F3F] hover:text-white transition-all shadow-sm border border-slate-100 shrink-0">
            ←
          </Link>
