  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="bg-white w-full max-w-[550px] rounded-[3.5rem] p-12 shadow-xl border border-slate-100">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-10 tracking-tighter italic text-center uppercase">Nueva Campaña</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* VALOR DE LA CAMPAÑA (ESTE ES EL CAMPO QUE FALTABA) */}
          <div className="space-y-2">
